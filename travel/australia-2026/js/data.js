...
const DAYS = [
  ...
  },
  {
    ...
    segments: [
      ...
      { time: '13:40', type: 'flight', title: '雪梨 T3 國內線出發', flightNo: 'QF532', duration: '約1小時35分', status: 'confirmed' },
      { time: '15:15', type: 'flight', title: '抵達布里斯本機場（國內航廈）', status: 'confirmed' },
      {
  ...
  },
  {
    ...
    segments: [
      ...
      { time: '21:50', type: 'flight', title: '墨爾本機場 T2 出發', flightNo: 'CI058', duration: '約9小時25分', status: 'confirmed' },
    ],
    notes: [],
  },
  {
    ...
    accommodation: null,
    segments: [
      { time: '04:15', type: 'flight', title: '抵達桃園機場 T2', status: 'confirmed' },
    ],
    notes: ['旅程結束，辛苦了！'],
  },
];
...
const CITY_GUIDES = {
  brisbane: {
    ...
    attractions: [
      { name: '市政廳 Brisbane City Hall', howTo: '火車到「Central Station」出站步行5分', desc: '位於喬治國王廣場，是公認「布里斯本最美的建築」之一' },
      { name: '布里斯本博物館 Museum of Brisbane', howTo: '在市政廳內', desc: '可免費登上「鐘塔」俯瞰廣場美景' },
      { name: '亞伯特教堂 Albert Street Uniting Church', howTo: '市政廳斜對面', desc: '' },
      { name: '皇后街購物中心', howTo: '市政廳的下一條街，「Central Station」出站步行5分', desc: '最熱鬧也是最好逛的一條街，可買紀念品，附近還有 David Jones、Myer、Wintergarden 等百貨' },
      { name: '南岸公園', howTo: '火車到「South Brisbane」出站步行約4分鐘', desc: '可戲水，市區必去的景點，拍字母地標' },
      { name: '故事橋', howTo: '火車到「Fortitude Valley」下車步行10分', desc: '可搭渡輪（免費/收費都有），河畔有很多餐廳，晚上橋會打燈' },
      { name: '布里斯本夜市 Eat Street', howTo: '', desc: '週五六日晚上營業，門票$6' },
      { name: 'West End Market 市集', howTo: '', desc: '週六限定市集，06:00-14:00' },
      { name: '龍柏動物園 Lone Pine Sanctuary', howTo: '火車於「Toowong」轉乘445號公車到動物園前下車', desc: '無尾熊、袋鼠、鴨嘴獸、袋熊等100種澳洲原生種動物' },
      { name: '摩頓島', howTo: '搭乘渡輪，或直接參加一日遊', desc: '世界第三大沙島，可體驗浮潛、划艇、衝沙、餵食海豚' },
    ],
  ...
  goldcoast: {
    ...
    attractions: [
      { name: '衝浪者天堂 Surfers Paradise', howTo: '', desc: '週三、五、日，下午～晚上8點可以逛「濱海市場」' },
      { name: 'Sky Point Q1大廈', howTo: '', desc: '77樓高空景觀台' },
      { name: 'Pacific Fair Shopping Centre', howTo: '', desc: '購物商場逛街' },
      { name: '可倫賓動物園 Currumbin Wildlife Sanctuary', howTo: '', desc: '' },
    ],
    food: [
      { name: 'Marios Italian Restaurant', detail: '好吃的義式餐廳，要預約' },
      { name: 'Costa D’oro Italian Restaurant and Pizzeria', detail: '義式餐廳，鮮蝦飯好吃' },
      { name: 'Pancakes On The Rocks', detail: '澳洲鬆餅名店，必點戰斧肋排' },
      { name: 'Hurricane’s Grill Surfer’s Paradise', detail: '澳洲有名的豬肋排店，必點「火焰燒烤豬」、「羊肋排」' },
    ],
  ...
  sydney: {
    ...
    accommodationArea: '中央車站附近',
    attractions: [
      { name: '雪梨歌劇院', howTo: '', desc: '' },
      { name: '環形碼頭', howTo: '歌劇院步行只要10分鐘', desc: '' },
      { name: '雪梨港灣大橋', howTo: '由北到南走約20分鐘，入口在岩石區：Argyle Stairs（爬樓梯）、Bridge Stairs（樓梯/電梯）', desc: '' },
      { name: '邦迪海灘', howTo: '搭乘333號巴士直達，1小時', desc: '城市海灘，可順遊冰山泳池與邦迪到庫吉海岸步道' },
      { name: '賞鯨', howTo: '史蒂芬港出發', desc: '' },
      { name: '岩石區、假日市集', howTo: '在環形碼頭左邊', desc: '假日市集不一定遇得到' },
      { name: '麥奎里夫人石椅 Mrs Macquarie’s Chair', howTo: '', desc: '拍港灣大橋、雪梨歌劇院的絕佳地點' },
      { name: '海德公園 + 聖母主教座堂', howTo: '從雪梨皇家植物園一路散步往南走', desc: '阿齊保噴泉指向教堂' },
      { name: '維多利亞女王大廈', howTo: '喬治街', desc: '購物中心，羅馬風建築' },
      { name: '雪梨塔 Sydney Tower Eye', howTo: '', desc: '有觀景台，也有旋轉餐廳（360 Bar and Dining）' },
      { name: '達令港', howTo: '', desc: '' },
      { name: '塔龍加動物園', howTo: '15分鐘車程', desc: '可看到無尾熊、袋鼠與雪梨港全景' },
      { name: '藍山國家公園 Blue Mountain', howTo: '搭乘火車約2小時，或報名一日遊', desc: '主要4個景點：景觀世界、回音谷、巨人階梯、三姊妹岩，可搭纜車俯瞰全景' },
    ],
    food: [{ name: 'Hurricane’s Grill 颶風炭烤豬肋排', detail: '環形碼頭分店' }],
    shopping: [],
  },
  melbourne: {
    name: '墨爾本',
    ...
    attractions: [
      { name: '佛林德茲街車站', howTo: 'Flinders St, Melbourne', desc: '白天晚上都可觀賞' },
      { name: 'Degraves Street 咖啡街', howTo: '福林德斯火車站斜對面的步行街', desc: '可吃早午餐' },
      { name: '聖保羅座堂', howTo: 'Flinders Street、Swanston Street 路口', desc: '8:00-18:00' },
      { name: '聯邦廣場', howTo: '火車站隔壁', desc: '' },
      { name: '塗鴉巷 Hosier Lane', howTo: '', desc: '' },
      { name: '維多利亞女皇市場', howTo: '', desc: '很多紀念品店、穿的、吃的，生蠔、熱狗、漢堡（像餐車）' },
      { name: '雅拉河畔', howTo: '', desc: '' },
      { name: '維多利亞州立圖書館 State Library Victoria', howTo: '', desc: '很美的圖書館，10:00-18:00' },
      { name: 'Melbourne Central', howTo: 'Cnr LaTrobe and Swanston Streets', desc: '百貨公司' },
      { name: '維多利亞藝術中心', howTo: '', desc: '' },
      { name: '皇家植物園', howTo: '', desc: '' },
      { name: '墨爾本戰爭紀念館', howTo: 'Birdwood Ave Melbourne', desc: '10:00-17:00，外觀像希臘神廟' },
      { name: '皇家拱廊、街區拱廊', howTo: '', desc: '商店街' },
      { name: '科林斯街', howTo: '', desc: '金融重地，很多精品、大飯店' },
      { name: '大洋路 Great Ocean Road', howTo: '', desc: 'Memorial Arch → Great Otway 國家公園 → 坎貝爾港國家公園十二使徒岩 → Maits Rest Rainforest Walk（30-45分）→ 阿德湖峽' },
      { name: '普芬比利小火車 Puffing Billy Railway', howTo: '貝爾格雷夫站至湖濱車站', desc: '需事先訂票，位子選前面較好拍照' },
      { name: '菲利浦島一日遊', howTo: '', desc: '彩虹小屋沙灘、月光野生動物園、格蘭特岬角及諾比斯、企鵝歸巢' },
      { name: '南墨爾本市場', howTo: '搭公車58', desc: '可吃可逛' },
    ],
    food: [
      { name: 'Mary Miller Café', detail: '早餐，咖啡廳' },
      { name: '椅子咖啡 Brother Baba Budan', detail: '' },
      { name: 'Seven Seeds Coffee', detail: '' },
      { name: 'Bratwurst Shop & Co 熱狗堡', detail: '週一、三公休' },
      { name: 'Hopetoun Tea Rooms', detail: '在拱廊，百年英式茶屋，甜點很美' },
      { name: 'Lune', detail: '可頌，Almond口味好吃，16/161 Collins St' },
